...
Shuaicong Hu holds a Ph.D. in Electronic Information from Fudan University (复旦大学, 破格提前毕业), where he was granted exceptional early graduation due to outstanding academic achievements. His research focuses on the interdisciplinary field of artificial intelligence and health medicine. His research focuses on the interdisciplinary field of artificial intelligence and health medicine. His core research areas include sleep artificial intelligence, medical AI, time series data analysis, personalized medicine, and unsupervised contrastive learning. To date, he has published 21 SCI papers, including 10 papers as sole first author (8), co-first author (1), and student first author (1), covering high-impact journals such as Information Fusion (IF=14.8, the highest IF journal in this field by Elsevier), Neural Networks (IF=6.0, CCF-B), Expert Systems With Applications (IF=7.5, CCF-C), IEEE JBHI (IF=7.7, featured as cover highlight article), and IEEE TNSRE (IF=4.9, highly cited in recent 2 years). Additionally, one Nature Communications paper (IF=14.7) as sole first author is currently under review after minor revision (the second paper in this field, with two reviewers recommending minor revision and one acceptance, evaluating it as a high-impact work in the field). His Google Scholar citations total 233 (181 as first author) with an H-index of 9.
...
<a href='https://scholar.google.com/citations?user=worq2P0AAAAJ&hl=zh-CN'>Google Scholar Profile <strong><span id='total_cit'>233</span></strong> citations</a>
<a href='https://scholar.google.com/citations?user=worq2P0AAAAJ&hl=zh-CN'><img src="https://img.shields.io/badge/Citations-233 (181 as first author)-blue?logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat"></a>
